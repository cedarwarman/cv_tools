...
PATH_TO_CKPT = "/home/bpp/warmanma/warman_nfs0/computer_vision/tensorflow/transfer_learning_1_trained_model/model/frozen_inference_graph.pb"
...
for image_path in TEST_IMAGE_PATHS:
    ...
    #plt.imsave("image_" + str(counter) + ".jpg", image_np)
